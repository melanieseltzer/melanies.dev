  ...
  return (
    <>
      ...
      <div className="prose prose-lg prose-slate mx-auto">
        ...
        <hr />
        <p className="lead">
          <strong>Until now</strong>, trying to style an article, document, or
          blog post with Tailwind has been a tedious task that required a keen
          eye for typography and a lot of complex custom CSS.
        </p>

        <p>
          <strong>By default</strong>, Tailwind removes all of the default
          browser styling from paragraphs, headings, lists and more. This ends
          up being really useful for building application UIs because you spend
          less time undoing user-agent styles, but when you <em>really are</em>{' '}
        ...
        <pre>
          <code className="language-js">asdf</code>
        </pre>
